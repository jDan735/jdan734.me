...
def wiki(page_name):
    ...
    style = '<link rel="stylesheet" href="/css/style.css?v=2.8.2"/><link rel="stylesheet" href="/css/wiki.css?v=1.9.3"/>'
    ...
    result = head + style + title + '<nav><ul><li><a class="home" href="/">Home</a></li><li><a class="lorem" href="/lorem">Lorem</a></li><li><a class="wiki active" href="/wiki/wikipedia">Википедия</a></li><li><a class="ftp-menu" href="/ftp">FTP</a></li><li><a class="bot" href="/bot">Bot</a></li></ul></nav>' + img + h1 + page_open + page + "</div></body>"
...
def ftp(path=""):
    ...
    return f'<!DOCTYPE html><html><head><link rel="icon" type="image/png" href="/favicon-16x16.png" sizes="16x16"><link rel="icon" type="image/png" href="/favicon-32x32.png" sizes="32x32"><link rel="icon" type="image/png" href="/favicon-96x96.png" sizes="96x96"><link rel="stylesheet" href="/css/style.css?v=2.8.2"><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>FTP</title></head><body class="index ftp"><nav><ul><li><a class="home" href="/">Home</a></li><li><a class="lorem" href="/lorem">Lorem</a></li><li><a class="wiki" href="/wiki/wikipedia">Википедия</a></li><li><a class="ftp-menu active" href="/ftp">FTP</a></li><li><a class="bot" href="/bot">Bot</a></li></ul></nav><h1 class="header ftp-menu">{h1}</h1><div><table>' + folders_table + folders + files_table + files + "</ul></div></body></html>"
